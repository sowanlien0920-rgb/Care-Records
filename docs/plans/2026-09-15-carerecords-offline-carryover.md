...
- [ ] **1b の見せ方。** Phase 5b の `## 7` は「直すと『この一覧は古いかもしれない』を
      全画面に出すことになり、表示の設計から決め直しになる」と書いている。
      どこに何を出すかは 1a を終えてから決める
...
- [x] ステップ4. エミュレータで確認（`## 6`）
- [ ] **1b（キャッシュ由来の古い一覧）** — 未着手。1a とは独立しているため分けた
